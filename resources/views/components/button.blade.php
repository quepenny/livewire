<{{ $tag }}
    @class([
        ...
        "relative $padding {$resolvedVariant['text']} $rounding $textSize flex items-center justify-center $font font-medium transition cursor-pointer",
        ...
        "{$resolvedVariant['background']} group overflow-hidden border-2 {$resolvedVariant['border']} {$resolvedVariant['hoverText']} focus:outline-none focus:ring-2 focus:ring-offset-2 {$resolvedVariant['focusRing']}" => !$hideBackground,
    ])
